  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:py-12">
      ...
      <div className="space-y-8">
        <SectionCard icon={<UsersRound className="h-5 w-5" />} title="发展历史与核心成员">
          <p>
        ...
        <SectionCard icon={<BookOpen className="h-5 w-5" />} title="社团特色文化">
          <ul id="courses">
        ...
        <SectionCard icon={<Sparkles className="h-5 w-5" />} title="关注我们">
          <ul id="contact">
